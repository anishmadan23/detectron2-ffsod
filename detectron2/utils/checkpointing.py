...
class PeriodicCheckpointer:
    ...
    def __init__(
        ...
        Args:
            ...
            best_model_mode (bool): If True, then does not keep into account the iteration while saving the ckpt. This saves space as we only use this to keep track of the best model based on val loss.
        """
    ...
    def step(self, iteration: int, **kwargs: Any) -> None:
        ...
        """
        if self.best_model_mode:
            self.checkpointer.save(f"{self.file_prefix}_final")
        else:
